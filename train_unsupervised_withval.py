...
if __name__ == '__main__':
    ...
    train_dataloader = DataLoader(train_ds, batch_size=batch_size, shuffle=False, pin_memory=True, num_workers=0)
    val_dataloader = DataLoader(val_ds, batch_size=batch_size, shuffle=False, pin_memory=True, num_workers=0)
    ...
    for epoch in range(epochs):
        for phase in ['train', 'val']:
            if phase == 'train':
                ...
                dataloader = tqdm(val_dataloader)
            ...
            for vis_features, real_feat, encoder_input, decoder_input, decoder_target, mask, region_true, lengths_enc, lengths_dec in dataloader:
                ...
                #    print("   {} - Real ith bbox prediction: {}".format(i_print, region_true))
                #    print("   {} - Pred ith bbox prediction: {}".format(i_print, torch.argmax(att_log,1)))
